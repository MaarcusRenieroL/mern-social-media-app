...
const Form = () => {
    ...
    return (
        <Formik initialValues={isLogin ? initialValuesLogin : initialValuesRegister} onSubmit={handleFormSubmit}
            ...
            {({
                ...
                <form onSubmit={handleSubmit}>
                    <Box display={"grid"} gap={"30px"} gridTemplateColumns={"repeat(4, minmax(0, 1fr)"} sx={{
                        ...
                        <TextField label={"Password"} onBlur={handleBlur} onChange={handleChange}
